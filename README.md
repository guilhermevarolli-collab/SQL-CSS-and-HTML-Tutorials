...
- Accessible and functional navigation
- Organized CSS with clear sections
- List, table, and form manipulation
- Responsive design using **media queries**
- Consistent and simple design principles
- Aligning images and text in multiple ways
- Separation of structure (HTML) from style (CSS)
...
5. Double-click `index.html` to start the site
